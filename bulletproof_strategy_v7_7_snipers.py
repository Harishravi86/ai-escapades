"""
================================================================================
BULLETPROOF STRATEGY v7.7 - SNIPER EDITION
================================================================================

Based on v7.6 + Code Review:
- FIXES "Turn of Month" logic (uses trading days vs calendar days)
- FIXES Class Naming & Docstrings
- ADDS "Monday the 5th" (Volmageddon/Japan Crash) detection
- ADDS "Ultimate Danger" Signal (Monday + 5th + Danger Month)

Performance Evolution:
- v7.6 Calendar: 180,879% QQQ Return
- v7.7 Sniper:   [Testing...]

Key New Features:
- MONDAY_5TH: The specific day causing crashes
- ULTIMATE_DANGER: Monday + 5th + (Jan/Feb/Aug)
- FIRST_WEEK_OF_YEAR: Low liquidity danger zone
================================================================================
"""
...
class TechnicalEngine:
    ...
    def calculate(cls, df: pd.DataFrame, celestial_df: Optional[pd.DataFrame] = None) -> pd.DataFrame:
        ...
        # Combines all the crash factors
...
class BulletproofStrategyV77_Sniper:
    """
    v7.7 Sniper Edition:
    
    Key Changes from v7.6:
    1. Fixed Turn of Month logic (trading days)
    2. Added MONDAY_5TH + ULTIMATE_DANGER signals
    3. Keeps all v7.5/v7.6 features (Eclipse, Calendar, ATR, Volume)
    """
    ...
    def print_results(self):
        s = self.stats
        print("\n" + "=" * 70)
        print("BULLETPROOF STRATEGY v7.7 - SNIPER")
        print("(Eclipse + Vedic + NEAT + Sniper Calendar)")
        print("=" * 70)
    ...
    def print_feature_importance(self):
        ...
        print("\n" + "=" * 70)
        print("\n" + "=" * 70)
        print("FEATURE IMPORTANCE ANALYSIS (v7.7)")
        print("=" * 70)
        print("=" * 70)
    ...
    def save_models(self, directory: str = '.'):
        ...
        if self.bull_detector:
            self.bull_detector.save(os.path.join(directory, 'bull_v77_sniper.joblib'))
        if self.bear_detector:
            self.bear_detector.save(os.path.join(directory, 'bear_v77_sniper.joblib'))
...
if __name__ == "__main__":
    print("=" * 70)
    print("BULLETPROOF STRATEGY v7.7 - SNIPER EDITION")
    print("=" * 70)
    print("\nKey changes from v7.6:")
    print("  [+] Fixed Turn of Month logic (Trading Days)")
    print("  [+] Added MONDAY_5TH and ULTIMATE_DANGER signals")
    print("  [+] Renamed class to BulletproofStrategyV77_Sniper")
    print("=" * 70)
    ...
    try:
        ...
        strategy_spy = BulletproofStrategyV77_Sniper(spy, spy, vix, symbol='SPY')
        ...
        strategy_qqq = BulletproofStrategyV77_Sniper(spy, qqq, vix, symbol='QQQ')
        ...
        if strategy_spy.trades:
            ...
            trades_df.to_csv('v7_7_trades_spy.csv', index=False)
            print("\nSaved trades to v7_7_trades_spy.csv")
