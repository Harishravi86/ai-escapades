"""
================================================================================
BULLETPROOF STRATEGY v7.6 - CALENDAR ENHANCED
================================================================================

Based on v7.5 Eclipse + New Feature Research:
- INTEGRATES ATR Volatility features (VOL_expansion, VOL_contraction)
- INTEGRATES Volume features (VOL_SPIKE, PANIC_VOLUME, TRIPLE_CAPITULATION)
- INTEGRATES Day 5 Calendar features (DAY_5_DANGER, DAY_5_BULLISH)
- INTEGRATES Turn of Month + First Trading Day features
- KEEPS all Eclipse + Vedic + NEAT features

Performance Evolution:
- v7.5 Original: 141,126% QQQ Return
- + ATR:         164,904% (+17%)
- + Volume:      173,595% (+6%)
- + Calendar:    258,843% (+49%)

Key New Features:
- ATR_ratio: Short/Long term volatility ratio
- VOL_ULTRA_SPIKE: Volume > 3 std above average
- DAY_5_DANGER: Aug/Feb 5th (bearish: -0.62%, 28% WR)
- TURN_OF_MONTH: Last 3 + First 2 days (4x edge)
================================================================================
"""
...
if __name__ == "__main__":
    print("=" * 70)
    print("BULLETPROOF STRATEGY v7.6 - CALENDAR ENHANCED")
    print("=" * 70)
    print("\nKey changes from v7.5:")
    print("  [+] ATR Volatility features (VOL_expansion, VOL_contraction)")
    print("  [+] Volume features (VOL_SPIKE, PANIC_VOLUME, TRIPLE_CAPITULATION)")
    print("  [+] Day 5 Calendar (DAY_5_DANGER, DAY_5_BULLISH)")
    print("  [+] Turn of Month + First Trading Day")
    print("=" * 70)
    ...
    try:
        ...
        if strategy_spy.trades:
            ...
            trades_df.to_csv('v7_6_trades_spy.csv', index=False)
            print("\nSaved trades to v7_6_trades_spy.csv")
