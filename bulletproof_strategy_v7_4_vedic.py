...
"""
================================================================================
BULLETPROOF STRATEGY v7.4 - VEDIC ML INTEGRATED
================================================================================

Based on v7.3 NEAT findings + v7.4 Vedic Research:
- INTEGRATES Sidereal Saturn Dignity (The +7.4% Uplift)
- INTEGRATES Saturn-Jupiter Great Conjunction Cycle
- KEEPS all v7.3 NEAT features (separation normalization)

Changes from v7.3:
- ADDS saturn_dignity (+1/0/-1) as ML feature
- ADDS saturn_jupiter_sep_normalized (0-1) as ML feature
- KEEPS is_mercury_retrograde (validated risk factor)

Key validation from Research:
- Saturn Dignity (Sidereal) acts as powerful long-term regime filter
- Sidereal (Vedic) outperformed Tropical (Western) by 65% in signal strength
================================================================================
"""
...
class CelestialEngine:
    ...
    def _calculate_features(self, date_str: str) -> Dict:
        ...
        return {
            ...
            # v7.4 Vedic Features
            'saturn_dignity': features.get('saturn_dignity', 0),
            'saturn_jupiter_sep_normalized': features.get('saturn_jupiter_sep', 0.0) / 180.0,
            'is_mercury_retrograde': features.get('is_mercury_retrograde', False), # v7.3 Legacy
...
class BulletproofStrategyV74_Vedic:
    """
    v7.4 Vedic Integrated:
    
    Key Changes from v7.3:
    1. Integrates Sidereal Saturn Dignity (The +7.4% edge)
    2. Integrates Great Conjunction Cycle
    3. Keeps all v7.3 NEAT logic
    """
...
if __name__ == "__main__":
    print("=" * 70)
    print("BULLETPROOF STRATEGY v7.4 - VEDIC ML INTEGRATED")
    print("=" * 70)
    print("\nKey changes from v7.3:")
    print("  [+] Integrates Sidereal Saturn Dignity (The +7.4% edge)")
    print("  [+] Integrates Great Conjunction Cycle")
    print("  [+] Keeps all v7.3 NEAT logic")
    print("=" * 70)
    ...
    try:
        ...
        strategy_spy = BulletproofStrategyV74_Vedic(spy, spy, vix, symbol='SPY')
        ...
        strategy_qqq = BulletproofStrategyV74_Vedic(spy, qqq, vix, symbol='QQQ')
        ...
        if strategy_spy.trades:
            ...
            trades_df.to_csv('v7_4_trades_spy.csv', index=False)
            print("\nSaved trades to v7_4_trades_spy.csv")
